...
export default function AddressCard({ address, onEdit, onDelete, onSetDefault }: Props) {
    ...
    return (
        <div className={`group relative rounded-xl border-2 p-4 transition-all hover:shadow-md ${address.es_principal ? 'bg-emerald-50/50 border-emerald-200' : 'bg-white border-slate-300'}`}>
