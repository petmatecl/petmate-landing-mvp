    ...
    return (
        <div className="p-8 max-w-[21cm] mx-auto bg-white text-slate-900 leading-relaxed font-sans" id="datasheet-content">
            ...
            <div className="grid grid-cols-2 gap-12 mb-10">
                {/* Fechas */}
                <div>
                    <h3 className="text-xs font-bold uppercase text-slate-400 mb-4 tracking-wider border-b border-slate-200 pb-2">Detalles del Servicio</h3>
                ...
                {/* Cliente */}
                <div>
                    <h3 className="text-xs font-bold uppercase text-slate-400 mb-4 tracking-wider border-b border-slate-200 pb-2">Datos del Usuario</h3>
            ...
            {/* Mascotas */}
            <div className="mb-10">
                <h3 className="text-xs font-bold uppercase text-slate-400 mb-6 tracking-wider border-b border-slate-200 pb-2">Mascotas a Cuidar</h3>
                <div className="grid grid-cols-1 gap-6">
                    {pets.map((pet, index) => (
                        <div key={index} className="flex gap-6 p-4 rounded-xl border-2 border-slate-200 bg-slate-50/50 break-inside-avoid">
                            {/* Icon / Image Placeholder */}
                            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center border-2 border-slate-200 shadow-sm shrink-0">
                            ...
                            <div className="flex-1 grid grid-cols-2 gap-x-8 gap-y-2">
                                <div className="col-span-2 mb-1 flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-medium px-2 py-0.5 bg-white border-2 border-slate-200 rounded text-slate-500 uppercase">{pet.tipo}</span>
                                </div>
            ...
            {/* Sitter Info (Footer) */}
            <div className="border-t-2 border-slate-200 pt-8 mt-12 flex items-center justify-between text-slate-500 text-sm">
                <div>
