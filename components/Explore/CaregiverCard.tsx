        ...
        <>
            <div className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white transition-all hover:shadow-lg hover:border-emerald-200">
                ...
                <div className="aspect-[4/3] w-full overflow-hidden bg-slate-100 relative">
                    ...
                    />
                    {verified && (
                        <div className="absolute top-3 right-3 rounded-full bg-white/90 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-emerald-700 shadow-sm backdrop-blur-sm">
                            Verificado
                        </div>
                    )}
                </div>
                ...
                <div className="flex flex-1 flex-col p-4">
                    <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-1 bg-amber-50 px-1.5 py-0.5 rounded-md">
                            ...
                            <span className="text-[10px] text-amber-600/70">({reviews})</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5 min-h-[24px]">
                        ...
                        {(modalidad === "a_domicilio" || modalidad === "ambos") && (
                            <span className="inline-flex items-center rounded bg-purple-50 px-1.5 py-0.5 text-[10px] font-medium text-purple-700 ring-1 ring-inset ring-purple-700/10">
                                🚗 A domicilio
                            </span>
                        )}
                    </div>
                    ...
                    <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
                        <div className="flex flex-col">
                            ...
                            <span className="text-sm font-bold text-slate-900">
                                ${price.toLocaleString("es-CL")} <span className="text-xs font-normal text-slate-500">/noche</span>
                            </span>
                        </div>

                        <button
                            onClick={handleProfileClick}
                            className="rounded-lg bg-emerald-50 px-4 py-2 text-sm font-bold text-emerald-700 hover:bg-emerald-100 transition-colors"
                        >
                            Ver perfil
                        </button>
                    </div>
