...
const RAW_POSTS: BlogPost[] = [
    {
        ...
        content: `
            ...
            <p class="mb-6 text-base leading-relaxed text-slate-600">
                ...
                <br/><br/>
                <span class="inline-flex items-center gap-1 font-medium text-accent-700 bg-accent-50 px-2 py-1 rounded">
            ...
            <h3 class="text-xl font-bold text-slate-800 mt-8 mb-4 flex items-center gap-2">
                <svg class="w-6 h-6 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
            ...
            <blockquote class="border-l-4 border-accent-600 bg-accent-50 p-4 text-slate-700 my-6 rounded-r-lg flex gap-3 items-start">
                <svg class="w-6 h-6 text-accent-600 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
            ...
            <h3 class="text-xl font-bold text-slate-800 mt-8 mb-4 flex items-center gap-2">
                <svg class="w-6 h-6 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" /></svg>
            ...
            <h3 class="text-xl font-bold text-slate-800 mt-8 mb-4 flex items-center gap-2">
                <svg class="w-6 h-6 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                4. Protector Solar
            </h3>
            <p class="mb-6 text-base leading-relaxed text-slate-600">
            ...
            <div class="bg-gray-50 border-2 border-slate-300 p-5 rounded-xl my-8 flex gap-4 items-start">
                <svg class="w-6 h-6 text-accent-600 flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                <div>
            ...
            <div class="mt-12 pt-8 border-t border-slate-300">
                ...
                <ul class="text-xs text-slate-500 space-y-2">
                    <li class="flex items-center gap-2">
                        ...
                        <a href="https://www.aspca.org/pet-care/general-pet-care/hot-weather-safety-tips" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">ASPCA - Hot Weather Safety Tips</a>
                    </li>
                    <li class="flex items-center gap-2">
                         <svg class="w-3 h-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        <a href="https://www.akc.org/expert-advice/health/summer-safety-tips-for-dogs/" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">American Kennel Club (AKC) - Summer Safety</a>
                    </li>
                </ul>
            </div>
        `
    },
    {
        ...
        content: `
            ...
            <h3 class="text-xl font-bold text-accent-600 mt-8 mb-4 flex items-center gap-2">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
                Síntomas de Alerta
            </h3>
            <div class="bg-accent-50 rounded-xl p-6 border border-accent-100 mb-8">
                <ul class="space-y-3 text-base text-slate-700">
                    <li class="flex items-start gap-2">
                        <svg class="w-5 h-5 text-accent-600 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
            ...
            <h3 class="text-xl font-bold text-slate-800 mt-8 mb-4 flex items-center gap-2">
                <svg class="w-6 h-6 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>
                ¿Qué hacer ante un golpe de calor?
            </h3>
            <ol class="list-none space-y-4 mb-8 text-base text-slate-600">
                <li class="flex gap-3 items-start">
                    <span class="flex-shrink-0 w-6 h-6 bg-accent-100 text-accent-600 rounded-full flex items-center justify-center font-bold text-xs mt-0.5">1</span>
                    <span><strong>Muévelo a la sombra</strong> inmediatamente y a un lugar ventilado.</span>
                </li>
                <li class="flex gap-3 items-start">
                    <span class="flex-shrink-0 w-6 h-6 bg-accent-100 text-accent-600 rounded-full flex items-center justify-center font-bold text-xs mt-0.5">2</span>
                    <span>Ofrece <strong>agua fresca</strong> (no helada) en pequeñas cantidades. No lo fuerces a beber si no quiere.</span>
                </li>
                <li class="flex gap-3 items-start">
                    <span class="flex-shrink-0 w-6 h-6 bg-accent-100 text-accent-600 rounded-full flex items-center justify-center font-bold text-xs mt-0.5">3</span>
                    <span>Moja sus <strong>patas, ingle y axilas</strong> con agua a temperatura ambiente. Evita el agua muy helada.</span>
                </li>
                <li class="flex gap-3 items-start">
                    <span class="flex-shrink-0 w-6 h-6 bg-accent-100 text-accent-600 rounded-full flex items-center justify-center font-bold text-xs mt-0.5">4</span>
                    <span>Utiliza un <strong>ventilador</strong> o abanico para ayudar a disipar el calor corporal.</span>
                </li>
                <li class="flex gap-3 items-start">
                    <span class="flex-shrink-0 w-6 h-6 bg-accent-100 text-accent-600 rounded-full flex items-center justify-center font-bold text-xs mt-0.5">5</span>
                    <span class="font-bold text-accent-600">¡Dirígete al veterinario de urgencia! Incluso si parece mejorar, puede haber daños internos.</span>
                </li>
            </ol>

            <h3 class="text-xl font-bold text-slate-800 mt-8 mb-4 flex items-center gap-2">
                <svg class="w-6 h-6 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
            ...
            <div class="mt-12 pt-8 border-t border-slate-300">
                <h4 class="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">Fuentes y Referencias</h4>
                 <ul class="text-xs text-slate-500 space-y-2">
                    <li class="flex items-center gap-2">
                        <svg class="w-3 h-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        <a href="https://www.avma.org/resources-tools/pet-owners/petcare/warm-weather-pet-safety" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">AVMA - Warm Weather Pet Safety</a>
                    </li>
                    <li class="flex items-center gap-2">
                         <svg class="w-3 h-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        <a href="https://www.humanesociety.org/resources/keep-pets-safe-heat" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">The Humane Society - Keep Pets Safe</a>
                    </li>
                </ul>
            </div>
        `
        ...
        content: `
            ...
            <div class="bg-accent-50 rounded-xl p-6 border border-accent-100 mb-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-white p-5 rounded-lg shadow-sm border border-accent-50">
                    ...
                    <div class="bg-white p-5 rounded-lg shadow-sm border border-accent-200 ring-2 ring-accent-50">
                        <span class="block text-xs text-accent-600 uppercase tracking-widest font-bold mb-2">Gato Indoor (Hogareño)</span>
                        <span class="text-3xl font-extrabold text-accent-600">12 a 15+ años</span>
            ...
            <ul class="space-y-4 mb-8 text-base text-slate-600">
                <li class="flex gap-3 items-start">
                    <svg class="w-5 h-5 text-accent-600 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    <div>
                        <strong class="text-accent-700">Leucemia Felina (FeLV):</strong> Se transmite por contacto cercano (acicalamiento, platos compartidos). Deprime el sistema inmune y es altamente mortal.
                    </div>
                </li>
                <li class="flex gap-3 items-start">
                    <svg class="w-5 h-5 text-accent-600 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    <div>
                        <strong class="text-accent-700">VIF (SIDA Felino):</strong> Transmitido principalmente por mordeduras profundas durante peleas territoriales.
                    </div>
                </li>
            </ul>
            ...
            <div class="bg-accent-50 p-6 rounded-xl border border-accent-100 mb-8">
                ...
                <cite class="text-xs text-accent-600 font-bold not-italic block text-right">— Nature Communications Study (2013)</cite>
            </div>
            <p class="mb-6 text-base leading-relaxed text-slate-600">
            ...
            <h3 class="text-xl font-bold text-slate-800 mt-8 mb-4 flex items-center gap-2">
                <svg class="w-6 h-6 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                Derribando Mitos Comunes
            </h3>
            
            <div class="space-y-6 mb-8">
                <div class="flex gap-4 items-start">
                    <div class="w-8 h-8 rounded-full bg-accent-100 flex items-center justify-center flex-shrink-0 text-accent-600 font-bold text-xs mt-1">❌</div>
                    <div>
            ...
            <ul class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-slate-600 mb-8">
                <li class="flex items-center gap-2">
                    <svg class="w-4 h-4 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
            ...
            <div class="mt-12 pt-8 border-t border-slate-300">
                ...
                <ul class="text-xs text-slate-500 space-y-2">
                    <li class="flex items-center gap-2">
                        <svg class="w-3 h-3 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
                        <a href="https://www.avma.org/" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">American Veterinary Medical Association (AVMA)</a>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="w-3 h-3 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
                        <a href="https://abcbirds.org/program/cats-indoors/" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">American Bird Conservancy - Cats Indoors</a>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="w-3 h-3 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
                        <a href="https://www.nature.com/articles/ncomms2380" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">Loss, S. R., Will, T. & Marra, P. P. The impact of free-ranging domestic cats on wildlife of the United States. Nat Commun (2013)</a>
                    </li>
                </ul>
            </div>
        `
    },
    {
        ...
        content: `
            ...
            <ul class="space-y-4 mb-8 text-base text-slate-600">
                <li class="flex gap-3 items-start">
                    <svg class="w-5 h-5 text-accent-600 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
                    <div>
                        <strong class="text-accent-700">Recuperación efectiva:</strong> Si tu mascota se pierde y alguien la encuentra, al escanear su microchip podrán contactarte inmediatamente gracias a los datos del registro.
                    </div>
                </li>
                <li class="flex gap-3 items-start">
                    <svg class="w-5 h-5 text-accent-600 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
                    <div>
                        <strong class="text-accent-700">Demostración de propiedad:</strong> Es el único documento oficial que acredita legalmente que eres el tutor de la mascota ante cualquier disputa.
                    </div>
                </li>
                 <li class="flex gap-3 items-start">
                    <svg class="w-5 h-5 text-accent-600 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" /></svg>
                    <div>
                        <strong class="text-accent-700">Evitas Multas:</strong> No tener a tu mascota inscrita puede conllevar multas que van desde 1 a 30 UTM.
                    </div>
                </li>
            </ul>

            <h3 class="text-xl font-bold text-slate-800 mt-8 mb-4 flex items-center gap-2">
                <svg class="w-6 h-6 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                Paso a Paso para la Inscripción
            </h3>
            
            <div class="bg-slate-50 border-l-4 border-accent-600 p-6 rounded-r-xl mb-8">
                <ol class="list-decimal list-inside space-y-4 text-slate-700 text-sm">
                    ...
                    <li>
                        <strong>Inscripción Online:</strong> Ingresa a <a href="https://registratumascota.cl" target="_blank" class="text-accent-600 font-bold hover:underline">registratumascota.cl</a> con tu Clave Única.
                    </li>
                    <li>
        ...
        content: `
            ...
            <div class="mt-12 pt-8 border-t border-slate-300">
                ...
                <ul class="text-xs text-slate-500 space-y-2">
                    <li class="flex items-center gap-2">
                        <svg class="w-3 h-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        <a href="https://www.cdc.gov/healthypets/health-benefits/index.html" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">CDC - Health Benefits of Owning a Pet</a>
                    </li>
                     <li class="flex items-center gap-2">
                        <svg class="w-3 h-3 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        <a href="https://www.mentalhealth.org.uk/explore-mental-health/a-z-topics/pets-and-mental-health" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">Mental Health Foundation - Pets and Mental Health</a>
                    </li>
                </ul>
            </div>
        `
    },
    {
        ...
        content: `
            ...
            <div class="space-y-6 mb-8">
                <div class="flex gap-4 items-start">
                    <div class="w-10 h-10 rounded-full bg-accent-100 flex items-center justify-center flex-shrink-0 text-accent-600 font-bold mt-1">
            ...
            <div class="mt-12 pt-8 border-t border-slate-300">
                ...
                <ul class="text-xs text-slate-500 space-y-2">
                    <li class="flex items-center gap-2">
                        <svg class="w-3 h-3 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>
                        <a href="https://www.aspca.org/pet-care/general-pet-care" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">ASPCA - General Pet Care & Stress Management</a>
                    </li>
                    <li class="flex items-center gap-2">
                         <svg class="w-3 h-3 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>
                        <a href="https://icatcare.org/advice/cats-and-stress/" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">International Cat Care - Environmental Stress in Cats</a>
                    </li>
                </ul>
            </div>
        `
    },
    {
        ...
        content: `
            ...
            <h3 class="text-xl font-bold text-accent-600 mt-8 mb-4">La Alternativa: Sitter Personalizado</h3>
            <p class="mb-6 text-base leading-relaxed text-slate-600">
             ...
             <div class="mt-12 pt-8 border-t border-slate-300">
                ...
                <ul class="text-xs text-slate-500 space-y-2">
                    <li class="flex items-center gap-2">
                        <svg class="w-3 h-3 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                        <a href="https://www.akc.org/expert-advice/home-living/boarding-kennel-vs-pet-sitter/" target="_blank" rel="nofollow noopener" class="hover:text-accent-600 hover:underline">AKC - Boarding Kennel vs. Pet Sitter</a>
                    </li>
                </ul>
            </div>
        `
