                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                        ...
                        <div className="flex items-center gap-3 mt-4 sm:mt-0">
                            ...
                            <Link href={profileId ? `/sitter/${profileId}` : '/explorar'} target="_blank" className="hidden sm:inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors">
                                Ver perfil público ↗
                            </Link>
                        </div>
                    </header>
                                            ...
                                            <div className="grid gap-3">
                                                {bookings.filter(b => b.estado === 'reservado').map(booking => (
                                                    <div key={booking.id} className="p-4 bg-white rounded-lg border border-slate-200 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                                        ...
                                                        <div className="text-xs text-slate-500 font-medium bg-slate-50 px-3 py-2 rounded-lg border border-slate-100 max-w-[200px] text-center">
