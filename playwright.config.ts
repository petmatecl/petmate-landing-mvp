...
export default defineConfig({
    ...
    projects: [
        ...
        },
        {
            ...
            testIgnore: /specs[\\/](f2-3|f2-recordatorios-cron|producto-2|conviene|visual|visits-doble|incidente-usuario-fix)[\\/]|specs[\\/]error-audit[\\/]c5-.*\.spec\.ts$|specs[\\/]tipo-b[\\/].*tutor.*\.spec\.ts$/,
        },
        {
            name: 'chromium-tutor',
            use: {
            ...
            // criterio de rol.
            testMatch: /specs[\\/](f2-3|producto-2|conviene|incidente-usuario-fix)[\\/].*\.spec\.ts$|specs[\\/]tipo-b[\\/].*tutor.*\.spec\.ts$/,
        },
        {
