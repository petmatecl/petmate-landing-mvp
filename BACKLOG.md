...
- **[abierto, PRIORIDAD ALTA (subida de media 2026-09-04) — bug PREEXISTENTE GENERAL de toda la app] Toast duplicado en TODAS las acciones del sitio**. **3 casos confirmados en 2 pantallas + 2 entornos** (última actualización sprint z-index-maps 2026-09-04):
